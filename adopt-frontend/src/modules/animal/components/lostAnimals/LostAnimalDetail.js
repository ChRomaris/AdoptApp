            ...
            <div className = "lostAnimalDetailContainer">
                <table>
                    <tbody>
                        ...
                        <tr><td className = "label"><FormattedMessage id = "form.label.breed"></FormattedMessage> : </td><td className = "value">{this.props.animal.breed.name}</td><td className = "label"><FormattedMessage id = "form.label.description"></FormattedMessage> : </td><td className = "value">{this.props.animal.description}</td></tr>
